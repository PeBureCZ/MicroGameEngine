...
public:
	...
	void setVertices(const std::shared_ptr<MgeDrawable>& newVertices) noexcept;
	[[nodiscard]] std::optional< std::shared_ptr<MgeDrawable>> getVertices();
...
private:
	...
	std::shared_ptr<MgeDrawable> drawableItem;
